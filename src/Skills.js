...
export default function SkillsAndTechnologies() {
	...
	return (
		<div className="skills-and-education-container">
			<button onClick={renderEducation}>Education</button>
			<button onClick={renderSkills}>Skills</button>
			<button onClick={renderTechnologies}>Technologies</button>
			<div className="render-area-skills-education">
				<renderEducation />
				<renderSkills />
				<renderTechnologies />
			</div>
